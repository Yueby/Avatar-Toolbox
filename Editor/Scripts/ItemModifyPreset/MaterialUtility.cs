...
namespace Yueby.Utils
{
    ...
    public static class MaterialUtility
    {
        ...
        public static readonly Dictionary<string, Color> ColorNameMap = new Dictionary<string, Color>()
        {
            ...
            {"red4", new Color(0.6f, 0.4f, 0.4f)},
            {"red5", new Color(0.5f, 0.5f, 0.5f)},
            ...
            {"green4", new Color(0.5f, 0.5f, 0.5f)},
            {"green5", new Color(0.6f, 0.4f, 0.4f)},

            {"blue", new Color(0.2f, 0.4f, 0.9f)},
            {"blue1", new Color(0.1f, 0.3f, 1.0f)},
            {"blue2", new Color(0.3f, 0.5f, 0.8f)},
            {"blue3", new Color(0.4f, 0.6f, 0.7f)},
            {"blue4", new Color(0.5f, 0.7f, 0.6f)},
            {"blue5", new Color(0.6f, 0.8f, 0.5f)},
            ...
            {"yellow4", new Color(0.6f, 0.6f, 0.5f)},
            {"yellow5", new Color(0.5f, 0.5f, 0.6f)},
            ...
            {"darkgreen4", new Color(0.25f, 0.2f, 0.25f)},
            {"darkgreen5", new Color(0.3f, 0.1f, 0.3f)},
            ...
            {"darkblue4", new Color(0.25f, 0.35f, 0.3f)},
            {"darkblue5", new Color(0.3f, 0.4f, 0.2f)},
            ...
            {"darkyellow4", new Color(0.3f, 0.3f, 0.25f)},
            {"darkyellow5", new Color(0.2f, 0.2f, 0.3f)},
            ...
            {"darkorange4", new Color(0.4f, 0.25f, 0.25f)},
            {"darkorange5", new Color(0.3f, 0.2f, 0.3f)},
            ...
            {"darkpurple4", new Color(0.25f, 0.25f, 0.3f)},
            {"darkpurple5", new Color(0.2f, 0.3f, 0.25f)},
            ...
            {"cyan4", new Color(0.6f, 0.6f, 0.6f)},
            {"cyan5", new Color(0.8f, 0.5f, 0.5f)},
            ...
            {"navy4", new Color(0.2f, 0.2f, 0.2f)},
            {"navy5", new Color(0.25f, 0.25f, 0.1f)},
            ...
            {"maroon4", new Color(0.2f, 0.2f, 0.2f)},
            {"maroon5", new Color(0.1f, 0.25f, 0.25f)},
            ...
            {"olive4", new Color(0.2f, 0.2f, 0.2f)},
            {"olive5", new Color(0.1f, 0.1f, 0.25f)},
            ...
            {"violet4", new Color(0.65f, 0.65f, 0.65f)},
            {"violet5", new Color(0.55f, 0.7f, 0.55f)},
            ...
            {"indigo4", new Color(0.15f, 0.2f, 0.25f)},
            {"indigo5", new Color(0.1f, 0.25f, 0.15f)},
            ...
            {"turquoise4", new Color(0.5f, 0.6f, 0.55f)},
            {"turquoise5", new Color(0.6f, 0.5f, 0.45f)},
            ...
            {"coral4", new Color(0.7f, 0.65f, 0.55f)},
            {"coral5", new Color(0.6f, 0.7f, 0.65f)},
            ...
            {"salmon4", new Color(0.7f, 0.65f, 0.6f)},
            {"salmon5", new Color(0.6f, 0.7f, 0.65f)},
            ...
            {"khaki4", new Color(0.7f, 0.65f, 0.7f)},
            {"khaki5", new Color(0.6f, 0.55f, 0.75f)},
            ...
            {"crimson4", new Color(0.6f, 0.25f, 0.4f)},
            {"crimson5", new Color(0.5f, 0.3f, 0.45f)},
        ...
        public static string ExtractColorNameFromPreset(string presetName)
        {
            ...
            // 存储最后一个匹配的颜色名称
            string lastMatchedColorName = null;
            ...
            foreach (var colorPair in ColorNameMap)
            {
                ...
                {
                    // 在原始字符串中查找颜色名称的位置
                    int startIndex = lowerName.IndexOf(colorPair.Key);
                    if (startIndex >= 0)
                    {
                        // 从原始字符串中提取颜色名称，保持原始大小写
                        lastMatchedColorName = presetName.Substring(startIndex, colorPair.Key.Length);
                    }
                    // 不直接返回，继续查找可能的更长匹配
                }
            }

            return lastMatchedColorName;
        }
    }
}
