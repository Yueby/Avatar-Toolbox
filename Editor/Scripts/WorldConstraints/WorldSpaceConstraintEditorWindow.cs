...
namespace Yueby.AvatarTools.WorldConstraints
{
    public class WorldSpaceConstraintEditorWindow : EditorWindow
    {
        ...
        {
            if (_prefab == null)
                _prefab = AssetDatabase.LoadMainAssetAtPath("Packages/yueby.tools.avatar-toolbox/Editor/Assets/WorldConstraints/Prefabs/WorldSpaceItem.prefab") as GameObject;
        }
